...
[![My Skills](https://skillicons.dev/icons?i=java,spring,maven,kafka,hibernate,js,ts,html,css,vue,nuxtjs,angular,react,nodejs,express,nestjs,electron,py,fastapi,flask,mysql,sqlite,mongodb,docker,git,github,linux,idea)](https://skillicons.dev)
