...
[![My Skills](https://skillicons.dev/icons?i=java,spring,maven,kafka,hibernate,js,ts,html,css,angular,vue,nuxtjs,nodejs,express,nestjs,electron,cs,go,py,fastapi,mysql,sqlite,mongodb,git,linux,idea)](https://skillicons.dev)
