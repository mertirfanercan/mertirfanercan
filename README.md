...
[![My Skills](https://skillicons.dev/icons?i=java,spring,maven,kafka,hibernate,js,ts,html,css,angular,vue,nuxtjs,nodejs,express,electron,cs,go,py,fastapi,mysql,mongodb,git,linux,idea,eclipse,postman,vscode)](https://skillicons.dev)
